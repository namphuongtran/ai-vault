...
Begin with **[Foundations]({{< relref "foundations" >}})** — Stage 0. It covers the core
building blocks: foundation models, generative AI, prompt engineering, RAG, agents,
guardrails, model evaluation, and responsible AI.
