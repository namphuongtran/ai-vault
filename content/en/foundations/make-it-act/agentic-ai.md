---
aliases: ["/foundations/agentic-ai/"]
title: "Agentic AI"
weight: 21
...
- **Agent** — the model decides the steps at runtime via a
  [reason → act → observe loop]({{< relref "agents.md" >}}). Flexible but harder to
  predict.
...
[context window]({{< relref "context-engineering.md" >}}), executes
[tool calls]({{< relref "tool-function-calling.md" >}}), stores memory, and enforces
...
That's why [evaluation]({{< relref "model-evaluation.md" >}}) and
[guardrails]({{< relref "guardrails.md" >}}) matter more the more agentic you go.
