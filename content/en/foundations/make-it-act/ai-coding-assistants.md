---
aliases: ["/foundations/ai-coding-assistants/"]
...
An AI coding assistant is an [agent]({{< relref "agents.md" >}}) for software work:
...
- A [foundation model]({{< relref "foundation-models.md" >}}) does the reasoning.
- The [agent loop]({{< relref "agents.md" >}}) runs *reason → act → observe*.
- [Tool & function calling]({{< relref "tool-function-calling.md" >}}) lets it edit
  files and run commands.
- [Context engineering]({{< relref "context-engineering.md" >}}) decides what code
  and history the model sees.
- [MCP]({{< relref "mcp.md" >}}) connects it to external tools and data.
...
[agent loop]({{< relref "agents.md" >}}), applied to code.
