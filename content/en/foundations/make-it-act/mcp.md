...
Before MCP, every app wired up [tools]({{< relref "tool-function-calling.md" >}}) and
...
- **Tools** — functions the model can call (see [Tool & function calling]({{< relref "tool-function-calling.md" >}})).
...
- **Limitations** — every server you connect **extends your attack surface**: a malicious or
  ...
  supply-chain threat in [AI security]({{< relref "ai-security.md" >}})); permissions
