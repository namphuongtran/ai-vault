...
[agent]({{< relref "agents.md" >}}) automates.
...
- **Validate inputs and gate risky actions** (see [Guardrails]({{< relref "guardrails.md" >}}));
...
> Skills, plugins, and [MCP]({{< relref "mcp.md" >}}) are all ways to *supply* tools
