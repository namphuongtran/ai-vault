...
- **Least privilege for tools** — grant the minimum; gate destructive actions behind human
  approval (see [Tool & function calling]({{< relref "tool-function-calling.md" >}})).
