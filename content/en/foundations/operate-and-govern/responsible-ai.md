...
| **Medium** — user-facing content | support answers, product copy | Autonomy + [guardrails]({{< relref "guardrails.md" >}}); review a sample |
...
This is the same machinery as [observability]({{< relref "observability.md" >}});
...
[guardrails]({{< relref "guardrails.md" >}}), and
