---
aliases: ["/foundations/how-llms-work/"]
title: "How LLMs Work"
weight: 4
...
[Context engineering]({{< relref "context-engineering.md" >}})).
...
[RAG]({{< relref "rag.md" >}}) and tools are for.

## Why this matters to you

- You pay per token → concise prompts and caching save money.
- Context is finite → manage what you put in it.
- Output is probabilistic → validate, and use [evaluation]({{< relref "model-evaluation.md" >}}).
