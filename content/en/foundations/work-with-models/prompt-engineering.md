...
| Multi-step logic goes wrong | **Chain-of-thought** — ask it to reason step by step (or use a [reasoning model]({{< relref "reasoning-models.md" >}})) |
...
| Every call repeats a long prefix | **Prompt caching** — a cost lever; see [Cost & tokens]({{< relref "cost-and-tokens.md" >}}) |
