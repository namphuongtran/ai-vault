---
aliases: ["/foundations/the-ai-api/"]
title: "The AI API"
weight: 9
...
[parameters]({{< relref "inference-parameters.md" >}}):
...
want the model to see; managing that is [context engineering]({{< relref "context-engineering.md" >}}).
