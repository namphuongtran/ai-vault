...
Hãy bắt đầu với **[Nền tảng]({{< relref "foundations" >}})** — Giai đoạn 0. Phần này bao gồm
các khối kiến thức cốt lõi: foundation model, generative AI, prompt engineering, RAG, agent,
guardrail, model evaluation và responsible AI.
