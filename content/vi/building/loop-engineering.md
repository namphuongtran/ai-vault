...
| ------ | ------ | ------ |
| **Kiến trúc** | **Open loop** — agent tự do khám phá, tự quyết bước sau · **Closed loop** — mục tiêu, tiêu chí, ngưỡng định trước | Open hợp bài chưa rõ hướng nhưng đốt token và khó đoán; closed rẻ hơn, lặp lại được, cải thiện dần — production mặc định closed |
