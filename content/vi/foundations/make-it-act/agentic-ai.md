...
- **Agent** — mô hình tự quyết các bước lúc chạy qua
  [vòng lặp reason → act → observe]({{< relref "agents.md" >}}). Linh hoạt nhưng khó đoán hơn.
...
[context window]({{< relref "context-engineering.md" >}}), thực thi
[tool call]({{< relref "tool-function-calling.md" >}}), lưu memory, và thực thi
...
[đánh giá]({{< relref "model-evaluation.md" >}}) và
[guardrail]({{< relref "guardrails.md" >}}) càng quan trọng khi bạn càng agentic.
