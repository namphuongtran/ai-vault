...
AI coding assistant là một [agent]({{< relref "agents.md" >}}) cho công việc phần
...
- Một [foundation model]({{< relref "foundation-models.md" >}}) đảm nhiệm suy luận.
- [Vòng lặp agent]({{< relref "agents.md" >}}) chạy *reason → act → observe*.
- [Tool & function calling]({{< relref "tool-function-calling.md" >}}) cho phép nó
  sửa file và chạy lệnh.
- [Context engineering]({{< relref "context-engineering.md" >}}) quyết định model
  thấy code và lịch sử nào.
- [MCP]({{< relref "mcp.md" >}}) nối nó với tool và dữ liệu bên ngoài.
...
[vòng lặp agent]({{< relref "agents.md" >}}), áp vào code.
