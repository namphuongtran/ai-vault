---
aliases: ["/foundations/tool-function-calling/"]
...
[agent]({{< relref "agents.md" >}}) tự động hoá.
...
- **Validate đầu vào và chặn hành động rủi ro** (xem [Guardrail]({{< relref "guardrails.md" >}}));
...
> Skill, plugin và [MCP]({{< relref "mcp.md" >}}) đều là cách *cung cấp* tool (và
