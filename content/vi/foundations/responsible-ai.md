...
| **Trung bình** — nội dung tới người dùng | câu trả lời support, mô tả sản phẩm | Tự chủ + [guardrails]({{< relref "/foundations/guardrails" >}}); review theo mẫu |
...
Đây chính là bộ máy của [observability]({{< relref "/foundations/observability" >}}); khác
...
[guardrails]({{< relref "/foundations/guardrails" >}}), và
