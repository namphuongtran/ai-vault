---
aliases: ["/foundations/multimodality/"]
title: "Multimodality"
...
- Bạn gửi ảnh **trong cùng `messages`** với text (xem [The AI API]({{< relref "the-ai-api.md" >}})).
...
- Một mô hình đa phương thức thì tiện; mô hình chuyên biệt có thể tốt hoặc rẻ hơn cho một
  phương thức duy nhất. Đây là đánh đổi khi [chọn model]({{< relref "choosing-a-model.md" >}}).
